...

    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import( /* webpackChunkName: "all appointment" */ '../views/AllAppointments.vue')
            },
            {
                path: '/add-text',
                name: 'add text',
            ...
            //mobile-view
            {
                path: '/patient-list',
                name: 'patient list',
                component: () => import( /* webpackChunkName: "patient list" */ '../views/Prescription/PatientList.vue')
            },
            {
