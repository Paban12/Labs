...
const SingleSelect2 = defineAsyncComponent(() => import('../components/Dropdown/SingleSelect2.vue'))
...
const DoctorSpecialization = defineAsyncComponent(() => import('../components/DoctorProfile/Specialization.vue'))
...
const GlobalComponents = {
  install (app) {
    ...
    app.component('SingleSelect2', SingleSelect2)
    ...
    app.component('DoctorSpecialization', DoctorSpecialization)
