<template>
  <section class="reports-page">
    <div class="card-sub-tabs mb-16">
      <div
        class="tab"
        @click.prevent="report.tab = 1"
        :class="report.tab === 1 ? 'active' : ''"
      >
        <div class="title">Patients</div>
      </div>
      <div
        class="tab"
        @click.prevent="report.tab = 2"
        :class="report.tab === 2 ? 'active' : ''"
      >
        <div class="title">Appointment Patients</div>
      </div>
    </div>
    <div class="tab-content" v-if="report.tab === 1">
      <div class="patient-no-list">
        <div class="no">
          <div class="text">Total New Patients</div>
          <div class="val">2</div>
        </div>
        <div class="no">
    ...
    <div class="tab-content" v-if="report.tab === 2">
      <div class="patient-no-list">
        <div class="no">
          <div class="text">Total New Patients</div>
          <div class="val">2</div>
      ...
      <div class="report-table">
        <div class="table-outer">
          <table class="table">
            ...
            <tbody>
              <tr v-for="(item, index) in patientAptData" :key="item">
                <td>{{ index + 1 }}</td>
                <td>{{ item.p_id }}</td>
                <td>{{ item.apt }}</td>
                <td>{{ item.name }}</td>
