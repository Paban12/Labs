<template>
  <section class="medicine-list-table common-list-page">
    <div class="container">
      <div class="card">
        <div class="heading">
          <div class="title">All Medicines</div>
          <div class="right">
            <div class="searchbar">
            ...
            <div class="add-btn">
              <router-link to="/add-medicine" class="btn black-btn"
                >Add new</router-link
              >
            </div>
          </div>
