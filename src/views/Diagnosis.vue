<template>
  <section class="formVar-page">
    <div class="container">
      <div class="card search-btn-head flex align-center justify-space mb-16">
        <div class="search flex align-center gap-16">
          <div class="text f-w-bold">Diagnosis Remembered </div>
          <div class="input">
        ...
        <div class="btns flex align-center gap-16">
          <div class="btn black-btn" @click.prevent="formVar.addModal = true">Add Diagnosis</div>
          <div class="btn clear-btn" @click.prevent="formVar.confirmModal = true">Delete Diagnosis</div>
        </div>
      </div>
      <div class="card">
    ...
    <Modal v-model:show="formVar.addModal" class="" headerClasses="header-bg">
      ...
      <form action="" class="form" @submit.prevent="onSubmitDiagnosis">
        <div class="form-item mb-16 mt-16">
          <input type="text" v-model="formVar.diagnosis" placeholder="Text">
          <div class="err-msg" v-if="formVar.submit && diagnosisValid">{{ diagnosisValid }}</div>
        </div>
...
/* Validation */
const diagnosisValid = computed(() => {
  if (!formVar.diagnosis) {
