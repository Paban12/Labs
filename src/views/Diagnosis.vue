    ...
    <div class="container">
      <div class="card search-btn-head flex align-center justify-space mb-16">
        ...
        <div class="btns flex align-center gap-16">
          <div class="btn black-btn" @click.prevent="notes.addModal = true">Add Diagnosis</div>
          <div class="btn clear-btn" @click.prevent="notes.confirmModal = true">Delete Diagnosis</div>
        </div>
      </div>
      <div class="card">
