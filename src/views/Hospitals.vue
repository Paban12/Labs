<template>
  <section class="doctors-page common-list-page">
    <div class="container">
      <div class="card">
        <div class="heading">
          <div class="title">All Hospitals</div>
          <div class="right">
            <div class="searchbar">
    ...
    <Modal v-model:show="formVar.addModal" class="" headerClasses="header-bg">
      <template v-slot:header>
        <div class="title" showHeader="true">Add Hospital</div>
        <div class="close-btn" @click.prevent="formVar.addModal = false">
          <icon-cross></icon-cross>
        </div>
      </template>
      <form action="" class="form" @submit.prevent="onSubmitHospital">
        ...
        <div class="form-item mb-16">
          <textarea v-model="formVar.address" placeholder="Enter Address"></textarea>
    ...
    <Modal v-model:show="formVar.viewModal" class="view-modal" headerClasses="header-bg">
      ...
      <div class="data">
        ...
        <div class="val">Rani Thakur Hospital</div>
      </div>
      <div class="data">
